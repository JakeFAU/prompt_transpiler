...
class PromptTranspilerPipeline:
    ...
    async def run(  # noqa: PLR0915, PLR0913, PLR0912
        ...
        Returns:
            The final CandidatePrompt generated by the pipeline.
...
async def transpile_pipeline(  # noqa: PLR0913
    ...
    Args:
        raw_text: The original prompt text or payload to transpile.
        source_model_name: The name of the original model.
        target_model_name: The name of the target model to optimize for.
        source_provider: Provider for source model. Defaults to "openai".
        target_provider: Provider for target model. Defaults to "openai".
        max_retries: Optional max retry limit.
        score_threshold: Optional threshold for candidate acceptance.
        scoring_algo: Optional name of the scoring algorithm to use.

    Returns:
        The optimized CandidatePrompt.
    """
    kwargs: dict[str, Any] = {}
