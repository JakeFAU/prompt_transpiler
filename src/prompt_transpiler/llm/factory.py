...
# ⚡ Bolt Optimization:
# Caching the provider instance to avoid the overhead of repeatedly
# initializing async LLM clients. This reduces CPU time and memory footprint
# when handling multiple requests for the same provider.
@functools.cache
