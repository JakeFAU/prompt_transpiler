...
from prompt_compiler.jobs.models import JobStatus
from prompt_compiler.jobs.store import MemoryJobStore, SQLiteJobStore
...
def test_duckdb_store_flow(tmp_path):
    ...
    from prompt_compiler.jobs.store import DuckDBJobStore  # noqa: PLC0415
