...
def mock_settings(mocker):
    mock_conf = mocker.patch("prompt_transpiler.llm.huggingface.settings")
...
def mock_hf_client(mocker):
    return mocker.patch("prompt_transpiler.llm.huggingface.AsyncInferenceClient")


@pytest.fixture
def mock_list_models(mocker):
    return mocker.patch("prompt_transpiler.llm.huggingface.list_models")
